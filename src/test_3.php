...
for($i = 0; $i < $drawsToPlay; $i++){
    ...
    //results are stored in extended array with parameters like 'least' => true, 'most' => true, 'random' => true, 'analyzedDraws' => 3, 'firsSelection' => ...
    //these parameters will be used by player to chose most appropriate strategy strategies to play
