        ...
        */
        ...
        'manual_player' => 
                        [
                          ...
                          'strategies' => ["LEAST_DRAWN","MOST_DRAWN","LEAST_DRAWN_AND_RANDOM","MOST_DRAWN_AND_RANDOM",
                          ...
                          'three_selections' => ['first' => [5,10,15,20,25,30,35,40], 'second' => [5,10,15,20,25,30,35,40],
                                                 'third' => [5,10,15,20,25]],
                        ],
        /**
        ...
        'auto_player' =>
                        [
                            ...
                            'players' => [
                                            ...
                                            8 =>[
                                                    'name' => 'Bat',
                                                    'description' => 'Cow goddess from early in Egyptian history, 
                                                                      eventually absorbed by Hathor',
													'max_selection' => 40,
                                                    'strategies' => ["LEAST_DRAWN","LEAST_AND_MOST_DRAWN",
                                                                     "MOST_LEAST_AND_RANDOM"],
                                                    'one_selection' => [25,30,35],
                                                    'two_selections' => ['first' => [25,30], 'second' => [5,10]],
                                                    'three_selections' => ['first' => [5,10], 'second' => [20,25],
                                                                           'third' => [5,10]],
                                                    'strategies_played' => 5,
                                                    'order_by' => 'orderByPicturesAndFrames'
                                                ],
                                            9 =>[
                                                    'name' => 'Ra',
                                                    'description' => 'The foremost Egyptian sun god, involved in creation and 
                                                                      the afterlife. 
                                                                      Mythological ruler of the gods, father of every Egyptian king, 
                                                                      and the patron god of Heliopolis',
													'max_selection' => 40,
                                                    'strategies' => ["MOST_DRAWN","LEAST_AND_MOST_DRAWN","MOST_LEAST_AND_RANDOM"],
                                                    'one_selection' => [25,30,35],
                                                    'two_selections' => ['first' => [5,10], 'second' => [25,30]],
                                                    'three_selections' => ['first' => [20,25], 'second' => [5,10],
                                                                           'third' => [5,10]],
                                                    'strategies_played' => 5,
                                                    'order_by' => 'orderByPicturesAndFrames'
                                                ],
                                            10 =>[
                                                    'name' => 'Nu',
                                                    'description' => 'Personification of the formless, watery disorder from which the 
                                                                      world emerged at creation and a member of the Ogdoad',
                                                    'max_selection' => 40,
                                                    ...
                                                    'three_selections' => ['first' => [5,10,15,20,25], 'second' => [5,10,15,20,25],
                                                                           'third' => [5,10]],
                                                    'strategies_played' => 5,
                                                    'order_by' => 'orderByPicturesAndFrames'
                                                 ],
		                            		/*11 =>[
		                            				...
		                            				'three_selections' => ['first' => [10,15,20,25], 'second' => [5,10,15,20],
                                                                           'third' => [5,10]],
		                            				'strategies_played' => 10,
		                            				'order_by' => 'orderByPicturesAndFrames'
												],
                                            ...
                                            14 =>[
                                                    ...
                                                    'three_selections' => ['first' => [5,10,15], 'second' => [5,10,15],
                                                                           'third' => [5,10]],
		                            		...
		                            		16 =>[
		                            				'name' => 'Isis',
		                            				'description' => 'Wife of Osiris and mother of Horus, linked with funerary 
		                            				                  rites, motherhood, protection, and magic',
		                            				'strategies_played' => 1,
		                            				'order_by' => 'orderByTotal'
		                            			],
		                            		17 =>[
		                            				'name' => 'Amun',
		                            				'description' => 'A creator god, patron deity of the city of Thebes, and 
		                            				                  the preeminent deity in Egypt during the New Kingdom',
		                            				'max_selection' => 45,
		                            				'strategies_played' => 2,
		                            				'order_by' => 'orderByTotal'
		                            		    ],
		                            		18 =>[
		                            				'name' => 'Osiris',
		                            				'description' => 'god of death and resurrection who rules the underworld 
		                            		...
		                            		19 =>[
		                            				'name' => 'Kek',
		                            				'description' => 'The god of Chaos and Darkness, as well as being the 
		                            				                  concept of primordial darkness',
		                            				'max_selection' => 35,
		                            				'strategies_played' => 10,
		                            				'order_by' => 'orderByTotal'
		                            		    ],
		                            		20 =>[
		                            				'name' => 'Horus',
		                            				'description' => 'A major god, usually shown as a falcon or as a human child, 
		                            				                  linked with the sky, the sun, kingship, protection, and 
		                            				                  healing',
		                            				'max_selection' => 30,
		                            				'strategies_played' => 25,
		                            				'order_by' => 'orderByTotal'
		                            		...
		                            		21 =>[
		                            				'name' => 'Hathor',
		                            				'description' => 'One of the most important goddesses, linked with the sky, 
		                            				                  the sun, sexuality and motherhood, music and dance, foreign 
		                            				                  lands and goods, and the afterlife',
		                            				'max_selection' => 25,
		                            				'strategies_played' => 50,
		                            				'order_by' => 'orderByTotal'
		                            		    ],*/
